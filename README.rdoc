...
http://tomzeng.com:8001/todos_mvc/app (single panel with realtime updates)

http://tomzeng.com:8001/todos/app     (two panels)

checkout the realtime updates with WebSocket (via Pusher/Slanger) in the pusher branch
...
link:https://github.com/tomz/Sencha-Touch-2-Todo-List-app/tree/i18n/Screenshot_todos_2panels-i18n.png
